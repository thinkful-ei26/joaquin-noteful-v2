...
INSERT INTO notes(title, content)values('Things to do with your life', 'All sorts of things and other things'),('Things to not do','Golf, read Shakespeare'),('Things to never do','Go back to high school, do a coding bootcamp'),('Things to never ever do no way ','Eat your feet, knit, learn Esperanto');
-- SELECT * FROM notes
